"use strict";(globalThis.webpackChunk=globalThis.webpackChunk||[]).push([["app_assets_modules_github_behaviors_include-fragment_ts-app_assets_modules_github_behaviors_r-4077b4","ui_packages_soft-navigate_soft-navigate_ts"],{93491:(e,t,r)=>{r.d(t,{I:()=>l,x:()=>s});var n=r(36162),a=r(36071),i=r(59753),o=r(76237);let d=new WeakMap;function l(e){let t=e.closest(".js-render-needs-enrichment");t&&(t.classList.remove("render-error"),d.get(t)?.setLoading(!1))}function s(e,t){let r=e.closest(".js-render-needs-enrichment");return!!r&&(r.classList.add("render-error"),d.get(r)?.setError(!0,t))}function c(e,t,r){let a=Object.entries(t).map(([e,t])=>`${e}=${t}`).join("&"),i=r.identifier??"",o=new URL(`${e}?${a}`,window.location.origin);return o.hash=i,n.dy`
    <div
